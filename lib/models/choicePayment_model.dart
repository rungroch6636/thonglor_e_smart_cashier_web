...
class ChoicePaymentModel {
  ...
  factory ChoicePaymentModel.fromMap(Map<String, dynamic> map) {
    return ChoicePaymentModel(
  ...
  factory ChoicePaymentModel.fromJson(String source) => ChoicePaymentModel.fromMap(json.decode(source) as Map<String, dynamic>);

  @override
  String toString() {
    return 'ChoicePaymentModel(tlpayment_id: $tlpayment_id, tlpayment_imed_total: $tlpayment_imed_total, tlpayment_actual_total: $tlpayment_actual_total, tlpayment_diff_abs: $tlpayment_diff_abs, tlpayment_rec_date: $tlpayment_rec_date, tlpayment_rec_time_from: $tlpayment_rec_time_from, tlpayment_rec_time_to: $tlpayment_rec_time_to, tlpayment_rec_site: $tlpayment_rec_site, tlpayment_rec_by: $tlpayment_rec_by, tlpayment_create_date: $tlpayment_create_date, tlpayment_create_time: $tlpayment_create_time, tlpayment_modify_date: $tlpayment_modify_date, tlpayment_modify_time: $tlpayment_modify_time, tlpayment_status: $tlpayment_status, tlpayment_merge_id: $tlpayment_merge_id, tlpayment_comment: $tlpayment_comment, tlpayment_imed_total_income: $tlpayment_imed_total_income, tlpayment_print_number: $tlpayment_print_number, tlpayment_approval_id: $tlpayment_approval_id)';
  }

  @override
  bool operator ==(covariant ChoicePaymentModel other) {
